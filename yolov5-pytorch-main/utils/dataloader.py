...
class YoloDataset(Dataset):
    def __init__(self, root_dir, device, annotation_lines, input_shape, num_classes, anchors, anchors_mask, epoch_length, \
        ...
        self.csv = pd.read_csv(os.path.join(root_dir, 'mot_labels.csv'))
    ...
    def __getitem__(self, idx):
        ...
        start_max = self.filter_list[idx+1] - 12
